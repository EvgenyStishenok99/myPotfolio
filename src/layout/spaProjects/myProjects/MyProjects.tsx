        ...
        <BlockForProject>
          ...
          <TextBlock>
            ...
            <Description>This is sample project
              ...
              are here in<br/> description This is sample
              project lorem ipsum generator for
              dummy content
            </Description>
            <TechStack>Tech stack<DedicatedTechStack>
              : HTML , JavaScript, SASS, React</DedicatedTechStack ></TechStack>
            <BottomForProjectBlock>
              <SvgWithText>
               <ChainSvg/>
                <p className="textForButtonPart">Live Preview</p>
              </SvgWithText>
              <SvgWithText>
                <LittleGitHubSvg/>
                <p className="textForButtonPart">View Code</p>
              </SvgWithText>
            </BottomForProjectBlock>
          </TextBlock>
        </BlockForProject>
      ...
      <div className="project">
        <div className="blockForProject">
          ...
          <div className="textBlock">
            ...
            <p className="description">This is sample project
              description random things
              are here in<br/> description This is sample
              project lorem ipsum generator for
              dummy content</p>
            <p className="techStack">Tech stack<mark className="dedicatedTechStack">
              : HTML , JavaScript, SASS, React</mark ></p>
            <div className="bottomForProjectBlock">
              <div className="svgWithText">
